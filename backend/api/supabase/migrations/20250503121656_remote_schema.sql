...
CREATE TABLE IF NOT EXISTS "public"."animal_production_log" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "chr" "text" NOT NULL,
    "year" integer NOT NULL,
    "species_name" "text" NOT NULL,
    "age_group" "text",
    "production_volume_equiv" numeric NOT NULL,
...
ALTER TABLE "public"."animal_production_log" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."site_yearly_summary" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "chr" "text" NOT NULL,
    "year" integer NOT NULL,
    "owner_cvr" "text",
    ...
    "production_equiv" numeric,
    "antibiotics_ddd" numeric,
 ...
 WITH "yearly_status_totals" AS (
         SELECT "c"."id" AS "company_id",
           ...
           FROM (("public"."companies" "c"
             ...
             JOIN "public"."field_bnbo_areas" "fba" ON (("fb"."id" = "fba"."field_boundary_id")))
...
CREATE MATERIALIZED VIEW "public"."land_use_summary" AS
 WITH "yearly_totals" AS (
         SELECT "c"."id" AS "company_id",
            ...
            "sum"(
                CASE
                    WHEN "fyd"."is_organic" THEN "fyd"."area_ha"
                    ELSE (0)::numeric
            ...
            COALESCE((("sum"(
                CASE
                    WHEN "fyd"."is_organic" THEN "fyd"."area_ha"
                    ELSE (0)::numeric
                END) / NULLIF("sum"("fyd"."area_ha"), (0)::numeric)) * (100)::numeric), (0)::numeric) AS "organic_percentage"
           FROM (("public"."companies" "c"
             JOIN "public"."field_boundaries" "fb" ON (("c"."id" = "fb"."company_id")))
             JOIN "public"."field_yearly_data" "fyd" ON (("fb"."id" = "fyd"."field_boundary_id")))
          GROUP BY "c"."id", "c"."municipality", "fyd"."year"
        )
 SELECT "yt"."company_id",
    "yt"."municipality",
    "yt"."year",
    "yt"."total_area_ha",
    "yt"."organic_area_ha",
    "yt"."organic_percentage",
    "rank"() OVER (PARTITION BY "yt"."year" ORDER BY "yt"."total_area_ha" DESC NULLS LAST) AS "rank_dk_total_area",
    "rank"() OVER (PARTITION BY "yt"."year", "yt"."municipality" ORDER BY "yt"."total_area_ha" DESC NULLS LAST) AS "rank_municipality_total_area",
    "rank"() OVER (PARTITION BY "yt"."year" ORDER BY "yt"."organic_area_ha" DESC NULLS LAST) AS "rank_dk_organic_total_area",
    "rank"() OVER (PARTITION BY "yt"."year", "yt"."municipality" ORDER BY "yt"."organic_area_ha" DESC NULLS LAST) AS "rank_municipality_organic_total_area"
...
CREATE MATERIALIZED VIEW "public"."environment_summary" AS
 WITH "yearly_env_totals" AS (
         SELECT "c"."id" AS "company_id",
            "c"."municipality",
            "fyd"."year",
            "sum"("fyd"."n_leached_kg") AS "total_n_leached_kg",
            "sum"("fyd"."pesticide_load_index") AS "total_pesticide_load_index",
            NULL::numeric AS "total_fertiliser_kg"
           FROM (("public"."companies" "c"
             JOIN "public"."field_boundaries" "fb" ON (("c"."id" = "fb"."company_id")))
             JOIN "public"."field_yearly_data" "fyd" ON (("fb"."id" = "fyd"."field_boundary_id")))
          GROUP BY "c"."id", "c"."municipality", "fyd"."year"
        ), "combined_data" AS (
         SELECT "et"."company_id",
            "et"."municipality",
            "et"."year",
            "et"."total_n_leached_kg",
            "et"."total_pesticide_load_index",
            "et"."total_fertiliser_kg",
            "lus"."total_area_ha",
            COALESCE(("et"."total_n_leached_kg" / NULLIF("lus"."total_area_ha", (0)::numeric)), (0)::numeric) AS "n_leached_kg_per_ha",
            COALESCE(("et"."total_pesticide_load_index" / NULLIF("lus"."total_area_ha", (0)::numeric)), (0)::numeric) AS "pesticide_load_index_per_ha"
           FROM ("yearly_env_totals" "et"
             LEFT JOIN "public"."land_use_summary" "lus" ON ((("et"."company_id" = "lus"."company_id") AND ("et"."year" = "lus"."year"))))
        )
 SELECT "cd"."company_id",
    "cd"."municipality",
    "cd"."year",
    "cd"."total_n_leached_kg",
    "cd"."total_pesticide_load_index",
    "cd"."total_fertiliser_kg",
    "cd"."total_area_ha",
    "cd"."n_leached_kg_per_ha",
    "cd"."pesticide_load_index_per_ha",
    "rank"() OVER (PARTITION BY "cd"."year" ORDER BY "cd"."total_fertiliser_kg" DESC NULLS LAST) AS "rank_dk_total_fertiliser_kg",
    "rank"() OVER (PARTITION BY "cd"."year", "cd"."municipality" ORDER BY "cd"."total_fertiliser_kg" DESC NULLS LAST) AS "rank_municipality_total_fertiliser_kg",
    "rank"() OVER (PARTITION BY "cd"."year" ORDER BY "cd"."n_leached_kg_per_ha" DESC NULLS LAST) AS "rank_dk_n_leached_kg_per_ha",
    "rank"() OVER (PARTITION BY "cd"."year", "cd"."municipality" ORDER BY "cd"."n_leached_kg_per_ha" DESC NULLS LAST) AS "rank_municipality_n_leached_kg_per_ha",
    "rank"() OVER (PARTITION BY "cd"."year" ORDER BY "cd"."pesticide_load_index_per_ha" DESC NULLS LAST) AS "rank_dk_pesticide_load_index_per_ha",
    "rank"() OVER (PARTITION BY "cd"."year", "cd"."municipality" ORDER BY "cd"."pesticide_load_index_per_ha" DESC NULLS LAST) AS "rank_municipality_pesticide_load_index_per_ha"
...
CREATE TABLE IF NOT EXISTS "public"."pesticide_applications" (
    ...
    "proximity_water_m" integer,
    "proximity_housing_m" integer,
    "proximity_school_m" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE MATERIALIZED VIEW "public"."site_species_production_ranked" AS
 WITH "site_species_totals" AS (
         SELECT "apl"."chr",
            "apl"."year",
            "apl"."species_id",
            "sum"("apl"."production_volume_equiv") AS "production_volume_equiv",
            "ps"."municipality"
           FROM ("public"."animal_production_log" "apl"
             JOIN "public"."production_sites" "ps" ON (("apl"."chr" = "ps"."chr")))
          WHERE ("apl"."species_id" IS NOT NULL)
          GROUP BY "apl"."chr", "apl"."year", "apl"."species_id", "ps"."municipality"
        )
 SELECT "sst"."chr",
    "sst"."year",
    "sst"."species_id",
    "s"."species_name",
    "sst"."municipality",
    "sst"."production_volume_equiv",
    "rank"() OVER (PARTITION BY "sst"."year", "sst"."species_id" ORDER BY "sst"."production_volume_equiv" DESC NULLS LAST) AS "rank_dk_species_production",
    "rank"() OVER (PARTITION BY "sst"."year", "sst"."municipality", "sst"."species_id" ORDER BY "sst"."production_volume_equiv" DESC NULLS LAST) AS "rank_municipality_species_production"
   FROM ("site_species_totals" "sst"
     JOIN "public"."species" "s" ON (("sst"."species_id" = "s"."species_id")))
  WITH NO DATA;
...
CREATE MATERIALIZED VIEW "public"."wetlands_summary" AS
 WITH "yearly_status_totals" AS (
         SELECT "c"."id" AS "company_id",
           ...
           FROM (("public"."companies" "c"
             JOIN "public"."field_boundaries" "fb" ON (("c"."id" = "fb"."company_id")))
             JOIN "public"."field_wetland_areas" "fwa" ON (("fb"."id" = "fwa"."field_boundary_id")))
...
ALTER TABLE ONLY "public"."animal_production_log"
    ADD CONSTRAINT "animal_production_log_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."field_boundaries"
    ADD CONSTRAINT "field_boundaries_company_id_field_identifier_key" UNIQUE ("company_id", "field_identifier");
...
ALTER TABLE ONLY "public"."field_yearly_data"
    ADD CONSTRAINT "field_yearly_data_field_boundary_id_year_key" UNIQUE ("field_boundary_id", "year");
...
ALTER TABLE ONLY "public"."site_yearly_summary"
    ADD CONSTRAINT "site_yearly_summary_chr_year_key" UNIQUE ("chr", "year");



ALTER TABLE ONLY "public"."site_yearly_summary"
    ADD CONSTRAINT "site_yearly_summary_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."species"
    ADD CONSTRAINT "species_species_code_unique" UNIQUE ("species_code");
...
CREATE INDEX "idx_animal_production_log_site_year_species" ON "public"."animal_production_log" USING "btree" ("chr", "year", "species_name");
...
CREATE INDEX "idx_animal_welfare_summary_year_mun_ranks" ON "public"."animal_welfare_summary" USING "btree" ("year", "municipality", "rank_municipality_total_animal_equivalents", "rank_municipality_total_ddd_usage", "rank_municipality_total_animals_transported");



CREATE INDEX "idx_animal_welfare_summary_year_ranks" ON "public"."animal_welfare_summary" USING "btree" ("year", "rank_dk_total_animal_equivalents", "rank_dk_total_ddd_usage", "rank_dk_total_animals_transported");
...
CREATE INDEX "idx_environment_summary_year_mun_ranks" ON "public"."environment_summary" USING "btree" ("year", "municipality", "rank_municipality_total_fertiliser_kg", "rank_municipality_n_leached_kg_per_ha", "rank_municipality_pesticide_load_index_per_ha");



CREATE INDEX "idx_environment_summary_year_ranks" ON "public"."environment_summary" USING "btree" ("year", "rank_dk_total_fertiliser_kg", "rank_dk_n_leached_kg_per_ha", "rank_dk_pesticide_load_index_per_ha");



CREATE INDEX "idx_field_bnbo_areas_field_year" ON "public"."field_bnbo_areas" USING "btree" ("field_boundary_id", "year");
...
CREATE INDEX "idx_field_wetland_areas_field_year" ON "public"."field_wetland_areas" USING "btree" ("field_boundary_id", "year");
...
CREATE INDEX "idx_field_yearly_data_field_boundary_id_year" ON "public"."field_yearly_data" USING "btree" ("field_boundary_id", "year");
...
CREATE INDEX "idx_land_use_summary_year_rank_dk" ON "public"."land_use_summary" USING "btree" ("year", "rank_dk_total_area");



CREATE INDEX "idx_land_use_summary_year_rank_mun" ON "public"."land_use_summary" USING "btree" ("year", "municipality", "rank_municipality_total_area");



CREATE INDEX "idx_pesticide_applications_company_id_year" ON "public"."pesticide_applications" USING "btree" ("company_id", "year");



CREATE INDEX "idx_pesticide_applications_pesticide_name" ON "public"."pesticide_applications" USING "btree" ("pesticide_name");
...
CREATE INDEX "idx_site_details_summary_ranked_year_mun_ranks" ON "public"."site_details_summary_ranked" USING "btree" ("year", "municipality", "rank_municipality_site_production", "rank_municipality_site_antibiotics", "rank_municipality_site_transport");



CREATE INDEX "idx_site_species_prod_ranked_year_mun_species_ranks" ON "public"."site_species_production_ranked" USING "btree" ("year", "municipality", "species_id", "rank_municipality_species_production");



CREATE INDEX "idx_site_species_prod_ranked_year_species_ranks" ON "public"."site_species_production_ranked" USING "btree" ("year", "species_id", "rank_dk_species_production");



CREATE INDEX "idx_site_yearly_summary_chr_year" ON "public"."site_yearly_summary" USING "btree" ("chr", "year");
...
CREATE UNIQUE INDEX "pk_animal_welfare_summary" ON "public"."animal_welfare_summary" USING "btree" ("company_id", "year");
...
CREATE UNIQUE INDEX "pk_environment_summary" ON "public"."environment_summary" USING "btree" ("company_id", "year");



CREATE UNIQUE INDEX "pk_land_use_summary" ON "public"."land_use_summary" USING "btree" ("company_id", "year");



CREATE UNIQUE INDEX "pk_site_details_summary_ranked" ON "public"."site_details_summary_ranked" USING "btree" ("chr", "year");



CREATE UNIQUE INDEX "pk_site_species_production_ranked" ON "public"."site_species_production_ranked" USING "btree" ("chr", "year", "species_id");
...
ALTER TABLE ONLY "public"."animal_production_log"
    ADD CONSTRAINT "animal_production_log_chr_fkey" FOREIGN KEY ("chr") REFERENCES "public"."production_sites"("chr") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."animal_production_log"
    ADD CONSTRAINT "animal_production_log_species_id_fkey" FOREIGN KEY ("species_id") REFERENCES "public"."species"("species_id");



ALTER TABLE ONLY "public"."animal_transports"
    ADD CONSTRAINT "animal_transports_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."animal_transports"
    ADD CONSTRAINT "animal_transports_species_id_fkey" FOREIGN KEY ("species_id") REFERENCES "public"."species"("species_id");



ALTER TABLE ONLY "public"."building_footprints"
    ADD CONSTRAINT "building_footprints_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."carbon_emission_factors"
    ADD CONSTRAINT "carbon_emission_factors_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."employee_monthly_counts"
    ADD CONSTRAINT "employee_monthly_counts_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."field_bnbo_areas"
    ADD CONSTRAINT "field_bnbo_areas_field_boundary_id_fkey" FOREIGN KEY ("field_boundary_id") REFERENCES "public"."field_boundaries"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."field_wetland_areas"
    ADD CONSTRAINT "field_wetland_areas_field_boundary_id_fkey" FOREIGN KEY ("field_boundary_id") REFERENCES "public"."field_boundaries"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."field_yearly_data"
    ADD CONSTRAINT "field_yearly_data_field_boundary_id_fkey" FOREIGN KEY ("field_boundary_id") REFERENCES "public"."field_boundaries"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."pesticide_applications"
    ADD CONSTRAINT "pesticide_applications_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pesticide_applications"
    ADD CONSTRAINT "pesticide_applications_field_boundary_id_fkey" FOREIGN KEY ("field_boundary_id") REFERENCES "public"."field_boundaries"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."production_sites"
    ADD CONSTRAINT "production_sites_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."production_sites"
    ADD CONSTRAINT "production_sites_main_species_id_fkey" FOREIGN KEY ("main_species_id") REFERENCES "public"."species"("species_id");



ALTER TABLE ONLY "public"."site_yearly_summary"
    ADD CONSTRAINT "site_yearly_summary_chr_fkey" FOREIGN KEY ("chr") REFERENCES "public"."production_sites"("chr") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."subsidy_details"
    ADD CONSTRAINT "subsidy_details_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."vet_events"
    ADD CONSTRAINT "vet_events_species_id_fkey" FOREIGN KEY ("species_id") REFERENCES "public"."species"("species_id");



ALTER TABLE ONLY "public"."visa_yearly_counts"
    ADD CONSTRAINT "visa_yearly_counts_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."worker_yearly_summary"
    ADD CONSTRAINT "worker_yearly_summary_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."yearly_financials"
    ADD CONSTRAINT "yearly_financials_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."animal_production_log" TO "anon";
GRANT ALL ON TABLE "public"."animal_production_log" TO "authenticated";
GRANT ALL ON TABLE "public"."animal_production_log" TO "service_role";
